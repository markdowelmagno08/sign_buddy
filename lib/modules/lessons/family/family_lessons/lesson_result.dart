  ...
  Future<void> getProgress(String lessonName) async {
    try {
      ...
      if (lessonData != null) {
        ...
        print(
            'Family lesson "$lessonName" was not found within the Firestore.');
        isLoading = true;
      }
    } catch (e) {
...
,                               ElevatedButton(
                        ...
                        if (confirmReset == true) {
                          ...
                          Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                  builder: (BuildContext context) => const Family()));
                    ...
                    TextButton(
                      onPressed: () async {
                        ...
                        Navigator.pushReplacement(
                          context,
                          SlidePageRoute(
                            page: Family(), // Replace with the desired page
                          ),
                        );
                      },
                      child: Column(
