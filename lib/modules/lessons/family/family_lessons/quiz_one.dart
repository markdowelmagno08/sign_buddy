...
class FamilyQuizOne extends StatefulWidget {
  final String lessonName;

  const FamilyQuizOne({Key? key, required this.lessonName}) : super(key: key);

  @override
  State<FamilyQuizOne> createState() => _FamilyQuizOneState();
}

class _FamilyQuizOneState extends State<FamilyQuizOne> {
 ...
 void getContent2DataByName(String lessonName) async {
  ...
  void _nextPage() async {
    Navigator.pushReplacement(
      context,
      SlidePageRoute(page: FamilyQuizTwo(lessonName: widget.lessonName)),
    );
