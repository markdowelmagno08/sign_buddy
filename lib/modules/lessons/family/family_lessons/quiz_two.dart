...
import 'package:sign_buddy/modules/lessons/family/family_lessons/quiz_three.dart';
import 'package:sign_buddy/modules/sharedwidget/page_transition.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:sign_buddy/modules/sharedwidget/shuffle_options.dart';

class FamilyQuizTwo extends StatefulWidget {
  final String lessonName;

  const FamilyQuizTwo({Key? key, required this.lessonName}) : super(key: key);

  @override
  State<FamilyQuizTwo> createState() => _FamilyQuizTwoState();
}

class _FamilyQuizTwoState extends State<FamilyQuizTwo> {
  ...
  Navigator.pushReplacement(
    context, SlidePageRoute(page: FamilyQuizThree(lessonName: widget.lessonName))
  );
