  ...
  Future<void> getProgress(String lessonName) async {
    try {
      ...
      if (lessonData != null) {
        ...
        print(
            'Color lesson "$lessonName" was not found within the Firestore.');
        isLoading = true;
      }
    } catch (e) {
...
,                               ElevatedButton(
                        ...
                        if (confirmReset == true) {
                          ...
                          Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                  builder: (BuildContext context) => const ColorLesson()));
                    ...
                    TextButton(
                      onPressed: () async {
                        ...
                        Navigator.pushReplacement(
                          context,
                          SlidePageRoute(
                            page: ColorLesson(), // Replace with the desired page
                          ),
                        );
                      },
                      child: Column(
