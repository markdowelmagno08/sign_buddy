...
class ColorQuizOne extends StatefulWidget {
  final String lessonName;

  const ColorQuizOne({Key? key, required this.lessonName}) : super(key: key);

  @override
  State<ColorQuizOne> createState() => _ColorQuizOneState();
}

class _ColorQuizOneState extends State<ColorQuizOne> {
  ...
  void _nextPage() {
    ...
    Navigator.pushReplacement(
    context, SlidePageRoute(page: ColorQuizTwo(lessonName: widget.lessonName))
    );
    if(mounted) {
      setState(() {
        selectedOption = '';
