...
class ColorQuizFour extends StatefulWidget {
  final String lessonName;

  const ColorQuizFour({Key? key, required this.lessonName}) : super(key: key);

  @override
  State<ColorQuizFour> createState() => _ColorQuizFourState();
}

class _ColorQuizFourState extends State<ColorQuizFour> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text('Colors lesson', style: TextStyle(color: Colors.black, fontSize: 16)),
