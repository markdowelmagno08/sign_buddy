...
import 'package:sign_buddy/modules/lessons/greetings/greetings/quiz_three.dart';
...
class GreetingsQuizTwo extends StatefulWidget {
  final String lessonName;

  const GreetingsQuizTwo({Key? key, required this.lessonName}) : super(key: key);

  @override
  State<GreetingsQuizTwo> createState() => _GreetingsQuizTwoState();
}

class _GreetingsQuizTwoState extends State<GreetingsQuizTwo> {
...
Widget _buildVideoOption(CachedVideoPlayerController controller, String option) {
 ...
 @override
  ...
  Navigator.pushReplacement(
    context, SlidePageRoute(page: GreetingsQuizThree(lessonName: widget.lessonName))
  );
