  ...
  Future<void> getProgress(String lessonName) async {
    try {
      ...
      if (lessonData != null) {
        ...
        print(
            'Greetings lesson "$lessonName" was not found within the Firestore.');
        isLoading = true;
      }
    } catch (e) {
...
,                               ElevatedButton(
                        ...
                        if (confirmReset == true) {
                          ...
                          await GreetingsLessonFireStore(
                          ...
                          Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                  builder: (BuildContext context) => const Greetings()));
                    ...
                    TextButton(
                      onPressed: () async {
                        ...
                        Navigator.pushReplacement(
                          context,
                          SlidePageRoute(
                            page: Greetings(), // Replace with the desired page
                          ),
                        );
                      },
                      child: Column(
