...
class GreetingsQuizFour extends StatefulWidget {
  final String lessonName;

  const GreetingsQuizFour({Key? key, required this.lessonName}) : super(key: key);

  @override
  State<GreetingsQuizFour> createState() => _GreetingsQuizFourState();
}

class _GreetingsQuizFourState extends State<GreetingsQuizFour> {
        ...
        child: Center(
          child: Column(
            ...
            children: words.map((word) {
              double wordFontSize = word.length > 10 ? 12.0 : fontSize; // Adjust font size based on character count
              return Text(
                word,
