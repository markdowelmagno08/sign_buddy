  ...
  Future<void> getProgress(String lessonName) async {
    try {
      ...
      if (lessonData != null) {
        ...
        print(
            'Animal lesson "$lessonName" was not found within the Firestore.');
        isLoading = true;
      }
    } catch (e) {
...
,                               ElevatedButton(
                        ...
                        if (confirmReset == true) {
                          ...
                          Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                  builder: (BuildContext context) => const Animals()));
                    ...
                    TextButton(
                      onPressed: () async {
                        ...
                        Navigator.pushReplacement(
                          context,
                          SlidePageRoute(
                            page: Animals(), // Replace with the desired page
                          ),
                        );
                      },
                      child: Column(
