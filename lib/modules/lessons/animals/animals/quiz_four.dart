...
class AnimalsQuizFour extends StatefulWidget {
  final String lessonName;

  const AnimalsQuizFour({Key? key, required this.lessonName}) : super(key: key);

  @override
  State<AnimalsQuizFour> createState() => _AnimalsQuizFourState();
}

class _AnimalsQuizFourState extends State<AnimalsQuizFour> {
